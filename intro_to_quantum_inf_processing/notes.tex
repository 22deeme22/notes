...
\section{Quantum error correction}
    ...
    \subsection{Quantum code distance}
        ...
        \begin{theoreme}
            If $\left(U, \Sigma\right)$ is a QECC then $\left(U, span\left(\Sigma\right)\right)$ is also a QECC. Then, to correct arbitrary errors like $\alpha E+ \beta F$, it suffices to correct $E,F \implies$ \important{quantum errors can be disretized!}
        \end{theoreme}
