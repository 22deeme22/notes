...
\section{Microservices}
    ...
    \end{tcolorbox}
    Real-world monoliths are complex and contain several functions, it suffer from synchronization overheads among threads, it doesn't scale well. Overhead limit monoliths from fully utlilizing all the cores and there is synchronization limits performance beyond a few cores. In resume, there is a lot of part that are dependent and should be synchronized.
    \begin{tcolorbox}[rouge]
