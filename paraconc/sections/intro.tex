...
These notes correspond to the course Parallelism and concurrency in software (CS-302).
...
\noindent The material presented here originates from the lectures themselves and from the instructors’ explanations.
